...
public class HandleMissionClaimRewardJob extends QuartzJobBean {

  protected static final Logger LOGGER = LoggerFactory.getLogger(HandleMissionClaimRewardJob.class);

  private final ScheduleLogRepository scheduleLogRepository;

  private final ScheduleRepository scheduleRepository;

  private final MissionClaimRewardService missionClaimRewardService;

  @Override
  protected void executeInternal(JobExecutionContext context) {
    // JOB TRA THUONG CHUOI NHIEM VU
    ...
    try {
      missionClaimRewardService.execute();
