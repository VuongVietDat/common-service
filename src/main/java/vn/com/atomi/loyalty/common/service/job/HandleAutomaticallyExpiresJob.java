...
public class HandleAutomaticallyExpiresJob extends QuartzJobBean {

  protected static final Logger LOGGER =
      LoggerFactory.getLogger(HandleAutomaticallyExpiresJob.class);
  ...
  protected void executeInternal(JobExecutionContext context) {
    ...
    try {
      loyaltyConfigClient.automaticallyExpiresRule(executeId);
